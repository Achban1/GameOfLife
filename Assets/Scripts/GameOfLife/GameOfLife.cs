...
public class GameOfLife : MonoBehaviour
{
    ...
    public float spawnChancePercentage = 0.2f; 
    ...
    void Start()
    {
        ...
        {
            spawnChancePercentage = SliderValueManager.instance.spawnRateValue;
        }
        if (SliderValueManager.instance != null)
        {
            spawnChancePercentage = SliderValueManager.instance.spawnRateValue;
            cellSize = SliderValueManager.instance.cellSizeValue;
        }
